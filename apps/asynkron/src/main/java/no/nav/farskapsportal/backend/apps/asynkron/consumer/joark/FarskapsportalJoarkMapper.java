...
import no.nav.farskapsportal.backend.libs.dto.joark.api.AvsenderMottaker;
import no.nav.farskapsportal.backend.libs.dto.joark.api.AvsenderMottakerIdType;
import no.nav.farskapsportal.backend.libs.dto.joark.api.Bruker;
import no.nav.farskapsportal.backend.libs.dto.joark.api.BrukerIdType;
import no.nav.farskapsportal.backend.libs.dto.joark.api.Dokument;
import no.nav.farskapsportal.backend.libs.dto.joark.api.DokumentVariant;
