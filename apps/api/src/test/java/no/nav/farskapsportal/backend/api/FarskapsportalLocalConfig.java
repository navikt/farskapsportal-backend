...
import static no.nav.farskapsportal.backend.api.FarskapsportalApplicationLocal.PROFILE_LOCAL;
import static no.nav.farskapsportal.backend.api.FarskapsportalApplicationLocal.PROFILE_LOCAL_POSTGRES;
import static no.nav.farskapsportal.backend.api.FarskapsportalApplicationLocal.PROFILE_REMOTE_POSTGRES;
