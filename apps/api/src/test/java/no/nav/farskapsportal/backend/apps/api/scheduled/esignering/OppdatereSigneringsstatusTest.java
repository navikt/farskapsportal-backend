...
public class OppdatereSigneringsstatusTest {
  ...
  void setup() {
    ...
    // Bønnen oppdatereSigneringsstatus er kun tilgjengelig for live-profilen for å unngå skedulert
    // trigging av metoden under test.
    oppdatereSigneringsstatus =
        OppdatereSigneringsstatus.builder()
  ...
  void
    ...
    farskapserklaeringSomManglerSigneringsstatus
        .getDokument()
        .setStatusQueryToken("tokenetMorFikkDaHunSignerte");
    ...
    // then
    verify(farskapsportalService, times(1))
        .synkronisereSigneringsstatusFar(farskapserklaering.getId());
  }
  ...
  void
    ...
    // then
    verify(farskapsportalService, times(0))
        .synkronisereSigneringsstatusFar(farskapserklaering.getId());
  }
