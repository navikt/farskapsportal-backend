...
public class HentPersonVergeEllerFremtidsfullmakt implements HentPersonSubResponse {
  ...
  public HentPersonVergeEllerFremtidsfullmakt(
      VergemaalEllerFremtidsfullmaktDto vergemaalEllerFremtidsfullmaktDto) {
    this.response = buildResponseVergeEllerFremtidsfullmakt(vergemaalEllerFremtidsfullmaktDto);
  }

  private String buildResponseVergeEllerFremtidsfullmakt(
      VergemaalEllerFremtidsfullmaktDto vergemaalEllerFremtidsfullmaktDto) {
    ...
    if (vergemaalEllerFremtidsfullmaktDto == null) {
      ...
      return startingElements
          + henteVergemaalEllerFremtidsfullmakt(vergemaalEllerFremtidsfullmaktDto)
          + closingElements;
    }
  }

  private String henteVergemaalEllerFremtidsfullmakt(
      VergemaalEllerFremtidsfullmaktDto vergemaalEllerFremtidsfullmaktDto) {
    ...
    vergemaalEllerFremtidsfullmaktElement.append(
        String.join(
            ...
            "  ",
            " \"omfang\": \""
                + vergemaalEllerFremtidsfullmaktDto.getVergeEllerFullmektig().getOmfang()
                + "\" },"));
