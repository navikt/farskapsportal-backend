...
import no.nav.farskapsportal.backend.api.FarskapsportalApiApplication;
...
import no.nav.farskapsportal.backend.api.config.FarskapsportalConfig;
import no.nav.farskapsportal.backend.api.service.FarskapsportalService;
...
public class FarskapsportalController {
  ...
  @Autowired
  private FarskapsportalConfig.OidcTokenSubjectExtractor oidcTokenSubjectExtractor;
