...
public class BrukerinformasjonResponse {
  ...
  @Parameter(
      description = "Brukers fornavn som registrert i Folkeregisteret",
      example = "Kari Nordmann")
  String brukersFornavn;

  @Parameter(
      description = "Personen kan initiere prosessen for å erklære farskap",
      example = "true")
  boolean kanOppretteFarskapserklaering;

  @Parameter(
      description = "Personen har en foreldrerolle som er støttet av løsningen",
      example = "true")
  ...
  @Parameter(
      description = "Farskapserklæringer som avventer signering av mottpart til pålogget bruker")
