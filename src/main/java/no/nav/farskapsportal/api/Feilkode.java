...
public enum Feilkode {
  ...
  PDL_BOSTEDSADRESSE_MANGLER("Respons fra PDL inneholdt ikke informasjon om persons bostedsadresse"),
  PDL_FOEDSELSDATO_TEKNISK_FEIL("Feil inntraff ved henting av fødselsdato fra PDL for person"),
  PDL_FOEDSELSDATO_MANGLER("Respons fra PDL inneholdt ingen informasjon om persons foedselsdato..."),
