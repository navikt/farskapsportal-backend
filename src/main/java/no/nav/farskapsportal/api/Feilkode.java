...
public enum Feilkode {
  ...
  FAR_HAR_IKKE_FNUMMER("Far er registrert med dnummer i PDL"),
  ...
  NAVNEKONTROLL_FEILET("Navnekontroll feilet. Navn på far stemmer ikke med navn registrert i folkeregisteret"),
  ...
  MOR_HAR_IKKE_FNUMMER("Mor er registrert med dnummer i PDL"),
