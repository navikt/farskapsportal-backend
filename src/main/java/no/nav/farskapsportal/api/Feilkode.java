...
public enum Feilkode {
  ...
  ERKLAERING_EKSISTERER_BARN("Det eksisterer allerede en farskapserklæring for oppgitt barn"),
  ERKLAERING_EKSISTERER_MOR("Mor har eksisterende farskapserklæring. Kan ikke opprette ny erklæring for ufødt barn."),
  ESIGNERING_REDIRECTURL_UKJENT("Redirect-url for ukjent part mottatt fra e-signeringsløsningen"),
  ESIGNERING_SIGNATUREIER_NULL("Signatureier er null i respons fra e-signeringsløsningen"),
  ...
  FEILFORMATERT_URL_NY_REDIRECT("Feilformatert redirect-url mottatt fra e-signeringsløsningen"),
  FEILFORMATERT_URL_UNDERTEGNERURL("URL for å hente ny redirect-url er feilformatert"),
  ...
  MEDMOR_ELLER_UKJENT("Medmor eller person med ukjent rolle kan ikke benytte løsningen"),
