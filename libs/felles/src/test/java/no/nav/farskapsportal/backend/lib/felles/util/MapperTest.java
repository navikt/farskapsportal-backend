...
import static no.nav.farskapsportal.backend.lib.felles.test.utils.TestUtils.henteForelder;
...
@SpringBootTest(classes = {FarskapsportalFellesConfig.class, TestUtils.class})
