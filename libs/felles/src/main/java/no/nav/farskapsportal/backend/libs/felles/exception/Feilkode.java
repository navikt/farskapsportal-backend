...
public enum Feilkode {
  ...
  BARN_HAR_FLERE_ERLAERINGER(
      "Feil i datagrunnlag. Barnet er involvert i mer enn én farskapserklæering"),
  BARN_HAR_IKKE_FNUMMER("Barnet er registrert med dnummer i PDL"),
  BOR_SAMMEN_INFO_KAN_BARE_OPPDATERES_AV_FAR(
      "Kun far kan oppdatere informasjon om han bor sammen med mor"),
  ...
  ERKLAERING_EKSISTERER_MOR(
      "Mor har eksisterende farskapserklæring. Kan ikke opprette ny erklæring for ufødt barn."),
  ...
  ESIGNERING_STATUS_FEILET(
      "Signeringsoppdraget har status feilet hos Posten, og signering kan ikke gjennomføres."),
  ...
  FARSKAPSERKLAERING_HAR_INKONSISTENTE_DATA("Farskapserklæringen har inkonsistente data"),
  ...
  FORELDER_HAR_VERGE(
      "Forelder er registrert med verge i Folkeregisteret, og kan derfor ikke bruke løsningen."),
  ...
  FORSKJELLIGE_FEDRE(
      "Mor kan ikke opprette farskapserklæringer med forskjellige fedre for samme kull nyfødte"),
  JOARK_OVERFOERING_FEILET(
      "En feil oppstod ved overføring til Joark. Farskapserklæringen ble ikke arkivert. Nytt forsøk ved neste intervall."),
  KONTROLLERE_FAR_NAVN_MANGLER("Navn på far mangler!"),
  MAKS_ANTALL_FORSOEK(
      "Mor har brukt opp antall mulige forsøk på å komme frem til riktig kombinasjon av fars fødselsnummer og navn"),
  ...
  MOR_SIVILSTAND_REGISTRERT_PARTNER(
      "Mor kan ikke opprette farskapserklæring dersom hun er registrert partner"),
  MOR_SIVILSTAND_UOPPGITT(
      "Mor kan ikke opprette farskapserklæring dersom hun har sivilstand uoppgitt"),
  NAVN_STEMMER_IKKE_MED_REGISTER(
      "Oppgitt navn til far stemmer ikke med fars navn i Folkeregisteret"),
  ...
  PDL_BOSTEDSADRESSE_MANGLER(
      "Respons fra PDL inneholdt ikke informasjon om personens bostedsadresse"),
  PDL_FOEDSELSDATO_TEKNISK_FEIL("Feil inntraff ved henting av fødselsdato fra PDL for person"),
  PDL_FOEDSELSDATO_MANGLER(
      "Respons fra PDL inneholdt ingen informasjon om personens foedselsdato..."),
  PDL_FOLKEREGISTERIDENTIFIKATOR_IKKE_FUNNET(
      "Respons fra PDL inneholdt ingen informasjon om personens folkeregisteridentifikator"),
  ...
  PERSON_HAR_ALLEREDE_SIGNERT(
      "Personen har allerede signert farskapserklæringen, og kan derfor ikke bestile ny redirect-url "),
  PERSON_IKKE_PART_I_FARSKAPSERKLAERING(
