...
import no.nav.farskapsportal.backend.lib.felles.consumer.brukernotifikasjon.Beskjedprodusent;
import no.nav.farskapsportal.backend.lib.felles.consumer.brukernotifikasjon.Ferdigprodusent;
...
@AllArgsConstructor
@Configuration
public class BrukernotifikasjonFellesConfig {
  ...
  public Map<String, Object> getKafkaConfigProps() {
