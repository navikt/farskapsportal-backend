...
public interface OppgavebestillingDao extends CrudRepository<Oppgavebestilling, Integer> {
  ...
  @Query(
      "select o from Oppgavebestilling o where o.farskapserklaering.id = :idFarskapserklaering and o.forelder.foedselsnummer = :fnr and o.eventId is not null and o.ferdigstilt is null")
