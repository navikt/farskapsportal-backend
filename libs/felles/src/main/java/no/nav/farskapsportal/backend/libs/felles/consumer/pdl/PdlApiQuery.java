...
public class PdlApiQuery {
  ...
  public static final String HENT_PERSON_FOLKEREGISTERIDENTIFIKATOR = readGraphQLQueryFromFile(
      "graphql/hent-person-folkeregisteridentifikator-query.graphql");
  public static final String HENT_PERSON_FORELDER_BARN_RELASJON = readGraphQLQueryFromFile(
      "graphql/hent-person-forelder-barn-relasjon-query.graphql");
