...
import static no.nav.farskapsportal.backend.lib.felles.consumer.pdl.PdlApiConsumerEndpointName.PDL_API_GRAPHQL;
import static no.nav.farskapsportal.backend.lib.felles.util.Utils.toSingletonOrThrow;
...
import no.nav.farskapsportal.backend.lib.felles.consumer.pdl.graphql.GraphQLRequest;
import no.nav.farskapsportal.backend.lib.felles.consumer.pdl.graphql.GraphQLResponse;
